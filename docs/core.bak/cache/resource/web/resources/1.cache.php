<?php  return array (
  ...
  array (
    ...
    <div class="container">
        <div id="utpGroup">
            <div class="utp wow fadeInUp" data-wow-duration="1.5s" data-wow-offset="30">
                <div class="utpBG1">
                    <h2>Собственное производство щитовой продукции</h2>
                    <a href="/" class="utpAbout">
                        Подробнее...
                    </a>
                </div>
            </div>
            <div class="utp wow fadeInUp" data-wow-duration="1.5s" data-wow-offset="30">
                <div class="utpBG2">
                    <h2>49 готовых проектных решений для ваших объектов</h2>
                    <a href="/" class="utpAbout">
                        Подробнее...
                    </a>
                </div>
            ...
            <div class="utp wow fadeInUp" data-wow-duration="1.5s" data-wow-offset="30">
                <div class="utpBG3">
                    <h2>Произодим расчет энергоэффектив-<br>ности</h2>
                    <a href="/" class="utpAbout">
                        Подробнее...
                    </a>
                </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 aboutFG">
                <h1 id="counts">ФОРУМ ЭЛЕКТРО</h1>
                <p>— это динамично развивающийся ведущий комплексный поставщик на рынке
                    электрооборудования в России.</p>
                <p>Мы являемся официальным дистрибьютором и представителем лучших европейских и российских
                    производителей электро- и светотехники.</p>
            </div>
            <div class="col-lg-5">
            ...
            <div class="col-lg-12">
                <img alt="Карта филиалов Форум Электро" id="forummap" src="/modx/assets/images/banners/homemap.png">
                <div class="row">
                    <div class="col-lg-6 numbers">
                        <p class="bigBlue spincrement">250</p>
                        <p class="smallGray">сотрудников</p>
                    </div>

                    <div class="col-lg-6 numbers">
                        <p class="bigBlue spincrement">60 000</p>
                        <p class="smallGray">клиентов</p>
                    </div>
                    <div class="col-lg-6 numbers">
                        <p class="bigBlue spincrement">12</p>
                        <p class="smallGray">филиалов в России</p>
                    </div>
                    <div class="col-lg-6 numbers">
                        <p class="bigBlue spincrement">400 000</p>
                        <p class="smallGray">эдектротехнических товаров</p>
                    </div>
                    <div class="col-lg-6 numbers">
                        <p class="bigBlue spincrement">13 000</p>
                        <p class="smallGray">метров складский помещений</p>
                    </div>
                    <div class="col-lg-6 numbers">
                        <p class="bigBlue spincrement">1100</p>
                        <p class="smallGray">городов обслуживания</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-5">
            ...
            <div class="col-lg-8 wow fadeInLeft" data-wow-duration="1.5s" data-wow-offset="30">
                <div class="row">
                    <div class="col-lg-4">
                        <div class="homeBlock1">
                            <img alt="" src="/modx/assets/images/icons/RAEClogoRU.png">
                            <p>
                                «ФОРУМ ЭЛЕКТРО» является членом РАЭК — Российской Ассоциации Электротехнических Компаний
                                —
                                cоюза независимых электротехнических компаний-дистрибьюторов, занимающих лидирующие
                                позиции, каждый в своем регионе
                            </p>
                            <img alt="" src="/modx/assets/images/icons/logo_main.png">
                            <img alt="" src="/modx/assets/images/icons/ETIM_national.png">
                            <a href="/" class="homeBlockLink">
                                Подробнее...
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="homeBlock2">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <img alt="" src="/modx/assets/images/icons/Znak.png">
                                            <p>
                                                Честная Позиция — добровольное объединение производителей и
                                                дистрибуторов,
                                                активно
                                                участвующих в преобразовании электротехнического рынка
                                            </p>
                                        </div>
                                        <div class="col-lg-6">
                                            <img src="/modx/assets/images/icons/cabelb.png">
                                            <img src="/modx/assets/images/icons/sootvet.png">
                                            <img src="/modx/assets/images/icons/standb.png">
                                        </div>
                                    </div>
                                    <a href="/" class="homeBlockLink">
                                        Подробнее...
                            ...
                            <div class="col-lg-6">
                                <div class="homeBlock3">
                                    <a href="/" class="homeTitleLink">
                                        Устойчивое развитие
                                    </a>
                                    <p>«ФОРУМ ЭЛЕКТРО» — динамично развивающаяся компания, с 20-и летней историей.
                                        Филиальная
                                        сеть, на сегодняшний день, насчитывает 10 офисов по всей России и продолжает
                                        расти</p>
                                    <a href="/" class="homeBlockLink">
                                        Подробнее...
                                    </a>
                            ...
                            <div class="col-lg-6">
                                <div class="homeBlock5"></div>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 homeNews">
    ...
    <div class="complexGray">
        <div class="container">
            <div class="complex">
                <h2>Комплексные решения</h2>
                <div class="row justify-content-center">
                    <div class="col-lg-9">
                        <p>Компания «ФОРУМ ЭЛЕКТРО» предлагает своим клиентам комплексные решения по оснащению, монтажу
                            и
                            проектированию электротехническими системами зданий и объектов различного назначения.</p>
                        <p>Среди многочисленных заказчиков и партнеров группы компаний «ФОРУМ ЭЛЕКТРО» известные
                            участники
                            строительного рынка, добывающей отрасли, предприятия промышленного сектора экономики, связи
                            и
                            информационных технологий, потребительского рынка, научно-технической и информационной сферы
                            деятельности.</p>
                    </div>
                </div>
                <div class="row justify-content-center">
                    <div class="col-lg-3 complexLink wow bounceIn" data-wow-duration="1.5s" data-wow-offset="30">
                        <a href="">
                            <img src="/modx/assets/images/icons/ComplexIcon1.png">
                            <p>Торговым партнерам</p>
                        </a>
                    </div>
                    <div class="col-lg-3 complexLink wow bounceIn" data-wow-duration="1.5s" data-wow-offset="30">
                        <a href="">
...
<div class="container">
    <div class="projects">
        <h2>Проектные поставки</h2>
        <div class="row">
            [[getResources? &amp;limit=`6` &amp;parents=`14` &amp;depth=`0` &amp;hideContainers=`0` &amp;tpl=`tplPostavkiHome`
            &amp;includeTVs=`1` &amp;sortby=`{"id"}` ]]
        </div>
    </div>
    <div class="brand">
        <h2>Партнеры</h2>
        <div class="row brandGroup">
            [[getResources? &amp;limit=`12` &amp;parents=`2` &amp;depth=`0` &amp;hideContainers=`0` &amp;tpl=`tplPartnerHome`
            &amp;includeTVs=`1` &amp;sortby=`{"id"}` ]]
        </div>
    </div>
</div>
    ...
    array (
      0 => 'heads',
      1 => '<link href="/modx/assets/css/home.css" rel="stylesheet">
<link href="/modx/assets/css/animate.css" rel="stylesheet">',
      2 => 'default',
      3 => NULL,
      4 => 'textarea',
    ),
    ...
    array (
      0 => 'foots',
      1 => '<script src="/modx/assets/js/jquery.spincrement.min.js"></script>
<script src="/modx/assets/js/wow.min.js"></script>
<script>
...
<head>
    ...
    <link href="/modx/assets/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    <link href="/modx/assets/fontawesome/css/fontawesome-all.css" rel="stylesheet">
    ...
    <link href="/modx/assets/css/common.css" rel="stylesheet">
    <link href="/modx/assets/css/home.css" rel="stylesheet">
<link href="/modx/assets/css/animate.css" rel="stylesheet">
</head>
<body>
<div id="header">
    <div id="topHeader">
        <div id="logo">
            <a href="/">
                <img alt="логотип сайта" src="/modx/assets/images/logo.png">
            </a>
        </div>
        <div class="topMenu">
            
<div><a href="/modx/about.html" >O компании</a></div>

<div><a href="/modx/partners/" >Партнеры</a></div>

<div><a href="/modx/contacts.html" >Контакты</a></div>
...
<div><a href="/modx/career.html" >Карьера</a></div>

<div><a href="/modx/uslugi/" >Услуги</a></div>

<div><a href="/modx/complex/" >Комплексные решения</a></div>

<div><a href="/modx/project/" >Проектные поставки</a></div>

<div><a href="/modx/proizvodstvo.html" >Производство</a></div>

<div><a href="/modx/news/" >Новости</a></div>
        </div>
    </div>
</div>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-4 homeNews">
                <h2>Последние новости</h2>
                <div class="homeNew">
    <div class="newDate"><div>22 мая 2018</div></div>
    <div class="newTitle"><a href="/mark-ot-dkc.html">Обновление системы маркировки "Mark" от DKC1</a></div>
    <div class="newText">ДКС продолжает расширять ассортимент продукции в рамках проекта "Система маркировки" и объявляет о запуске новой системы печати "MarkTC".</div>
</div>
<div class="homeNew">
    <div class="newDate"><div>16 апреля 2012</div></div>
    <div class="newTitle"><a href="/postavka-oborudovaniya-srednego-napryazhenia.html">ЗАО «Форум Нева» начало поставки оборудования среднего напряжения!</a></div>
    <div class="newText">Специалисты ЗАО «Форум Нева» готовы помочь Вам с выбором типа оборудования, оказать техническую консультацию, предоставить типовые альбомы или техническую информацию по поставляемому оборудованию.</div>
</div>
<div class="homeNew">
    <div class="newDate"><div>14 мая 2012</div></div>
    <div class="newTitle"><a href="/preobrazovateli-chastoti-altivar-61.html">Новые преобразователи частоты Altivar 61 с системой активного подавления гармоник</a></div>
    <div class="newText">Простое проектирование - модульные варианты конструкции с возможность размещения дополнительного оборудования заказчика.</div>
</div>
            </div>
        </div>
    </div>
...
<div class="container">
    ...
    <a class="posImg" style="background-image: url(assets/images/redside.jpg);">
        <div class="posBack">
            <div class="posTitle">
                ЖК «Ред Сайд»
            </div>
            <div class="posText">
                ...
                <span class="posTextW">Год: 2016 год</span>
            </div>
        </div>
    </a>
</div>
<div class="col-lg-4 pos">
    <a class="posImg" style="background-image: url(assets/images/bikovogaz.jpg);">
        <div class="posBack">
            <div class="posTitle">
                БыковоГаз
            </div>
            <div class="posText">
                ...
                <span class="posTextW">Год: 2017 год</span>
            </div>
        </div>
    </a>
</div>
<div class="col-lg-4 pos">
    <a class="posImg" style="background-image: url(assets/images/Urengoj-PurPe.jpeg);">
        <div class="posBack">
            <div class="posTitle">
                Нефтеконденсатопровод Уренгой-Пурпе
            </div>
            <div class="posText">
                <span class="posTextW">
                    Бренд: DKC
...
<div class="col-lg-4 pos">
    <a class="posImg" style="background-image: url(assets/images/chajandinskoe-mectorozhdenie.jpg);">
        <div class="posBack">
            <div class="posTitle">
...
<div class="col-lg-4 pos">
    <a class="posImg" style="background-image: url(assets/images/RadissonBluOlympiysky.jpg);">
        <div class="posBack">
            <div class="posTitle">
                Radisson Blu Olympiysky
            </div>
            <div class="posText">
                <span class="posTextW">
                    Бренд: ABB
                ...
                <span class="posTextW">Год: 2018 год</span>
            </div>
        </div>
    </a>
</div>
<div class="col-lg-4 pos">
    <a class="posImg" style="background-image: url(assets/images/sadi-pekina.jpg);">
        <div class="posBack">
            <div class="posTitle">
                ЖК «Сады Пекина»
            </div>
    ...
    <div class="brand">
        ...
        <div class="row brandGroup">
            <div class="col-lg-2">
    <a href="/abb.html">
        <img src="assets/images/abb-logo-png-transparent1.png" class="partnerImage">
    </a>
</div>

<div class="col-lg-2">
    <a href="/kuzocm.html">
        <img src="assets/images/kuzocm1.png" class="partnerImage">
    </a>
</div>

<div class="col-lg-2">
    <a href="/inkotex.html">
        <img src="assets/images/inkotex1.png" class="partnerImage">
    </a>
</div>

<div class="col-lg-2">
    <a href="/dkc.html">
        <img src="assets/images/DKC1.jpg" class="partnerImage">
    </a>
</div>

<div class="col-lg-2">
    <a href="/schneider-electric.html">
        <img src="assets/images/SchneiderElectric_Logo1.png" class="partnerImage">
    </a>
</div>

<div class="col-lg-2">
    <a href="/svetovye-tehnologii.html">
        <img src="assets/images/Svet1.png" class="partnerImage">
    </a>
</div>

<div class="col-lg-2">
    <a href="/iek.html">
        <img src="assets/images/iek1.png" class="partnerImage">
    </a>
</div>

<div class="col-lg-2">
    <a href="/meka.html">
        <img src="assets/images/meka1.png" class="partnerImage">
    </a>
</div>

<div class="col-lg-2">
    <a href="/tdm-еlectric.html">
        <img src="assets/images/logo_elektro-1.png" class="partnerImage">
    </a>
</div>

<div class="col-lg-2">
    <a href="/ekf.html">
        <img src="assets/images/ekf1.png" class="partnerImage">
    </a>
</div>

<div class="col-lg-2">
    <a href="/legrand.html">
        <img src="assets/images/logo-legrand1.png" class="partnerImage">
    </a>
</div>

<div class="col-lg-2">
    <a href="/vergokan.html">
        <img src="assets/images/Vergokan.png" class="partnerImage">
    </a>
</div>
...
<div id="footer">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <img alt="логотип форум электро" src="/modx/assets/images/footerlogo.png">
            </div>
            <div class="col-lg-3">
                <p>Ведущий комплексный поставщик
                    на рынке электрооборудования в России и Европы</p>
                <a href="">
...
<div><a href="/modx/news/" >Новости</a></div>
            ...
            <div class="col-lg-3 footcont">
                <a href="">+7 495 649-69-71</a>
                <a href="">+7 495 649-69-71</a>
                <a href="">contact@forumgroup.ru</a>
                <a href="" id="footbut">Задать вопрос</a>
            </div>
            <div class="col-lg-4" id="copyright">
                <p>© 1998-2018, «ФОРУМ ЭЛЕКТРО»</p>
            </div>
            <div class="col-lg-8 footIconGroup">
                <img alt="РАЭК" src="/modx/assets/images/icons/raek_icon.png">
                <img alt="Кабель безопасности" src="/modx/assets/images/icons/cabel_icon.png">
                <img alt="Imelco" src="/modx/assets/images/icons/imelco_icon.png">
                <img alt="Честная позиция" src="/modx/assets/images/icons/cp_icon.png">
                <img alt="ETIM" src="/modx/assets/images/icons/etim_icon.png">
            </div>
        </div>
    </div>
</div>
<script src="/modx/assets/js/jquery-3.3.1.min.js"></script>
<script src="/modx/assets/bootstrap/js/bootstrap.bundle.min.js"></script>
<script src="/modx/assets/js/jquery.spincrement.min.js"></script>
<script src="/modx/assets/js/wow.min.js"></script>
<script>
...
',
  ...
  'elementCache' => 
  array (
    '[[*heads]]' => '<link href="/modx/assets/css/home.css" rel="stylesheet">
<link href="/modx/assets/css/animate.css" rel="stylesheet">',
...
',
    '[[~8? &scheme=`full`]]' => '/mark-ot-dkc.html',
    '[[~19? &scheme=`full`]]' => '/postavka-oborudovaniya-srednego-napryazhenia.html',
    '[[~20? &scheme=`full`]]' => '/preobrazovateli-chastoti-altivar-61.html',
    '[[getResources?
                &limit=`3`
                &parents=`7`
                &depth=`0`
...
<div class="homeNew">
    ...
    '[[getResources? &limit=`0` &parents=`-1` &resources=`` &tpl=`tplBrandSelector`]]' => '',
    '[[getResources? &limit=`0` &parents=`-1` &resources=`` &tpl=`tplBrandSelector2`]]' => '',
    '[[getResources? &limit=`0` &parents=`-1` &resources=`` &tpl=`tplBrandSelector3`]]' => '',
    '[[getResources? &limit=`0` &parents=`-1` &resources=`93` &tpl=`tplGroupSelecror`]]' => 'Кабельно-проводниковая продукция',
    '[[getResources? &limit=`0` &parents=`-1` &resources=`` &tpl=`tplGroupSelecror2`]]' => '',
    '[[getResources? &limit=`0` &parents=`-1` &resources=`93` &tpl=`tplGroupSelecror3`]]' => '<hr>',
    '[[getResources? &limit=`0` &parents=`-1` &resources=`62` &tpl=`tplBrandSelector`]]' => 'Бренд: IEK',
    '[[getResources? &limit=`0` &parents=`-1` &resources=`59` &tpl=`tplBrandSelector2`]]' => '| DKC',
    '[[getResources? &limit=`0` &parents=`-1` &resources=`62` &tpl=`tplBrandSelector3`]]' => '<hr>',
    '[[getResources? &limit=`0` &parents=`-1` &resources=`90` &tpl=`tplGroupSelecror2`]]' => '| Кабеленесущие системы',
    '[[getResources? &limit=`0` &parents=`-1` &resources=`59` &tpl=`tplBrandSelector`]]' => 'Бренд: DKC',
    '[[getResources? &limit=`0` &parents=`-1` &resources=`59` &tpl=`tplBrandSelector3`]]' => '<hr>',
    '[[getResources? &limit=`0` &parents=`-1` &resources=`61` &tpl=`tplBrandSelector2`]]' => '| Световые технологии',
    '[[getResources? &limit=`0` &parents=`-1` &resources=`89` &tpl=`tplGroupSelecror`]]' => 'Светотехническая продукция',
    '[[getResources? &limit=`0` &parents=`-1` &resources=`89` &tpl=`tplGroupSelecror3`]]' => '<hr>',
    '[[getResources? &limit=`0` &parents=`-1` &resources=`11` &tpl=`tplBrandSelector`]]' => 'Бренд: ABB',
    '[[getResources? &limit=`0` &parents=`-1` &resources=`11` &tpl=`tplBrandSelector3`]]' => '<hr>',
    '[[getResources? &limit=`0` &parents=`-1` &resources=`91` &tpl=`tplGroupSelecror`]]' => 'Электроустановочное оборудование',
    '[[getResources? &limit=`0` &parents=`-1` &resources=`92` &tpl=`tplGroupSelecror2`]]' => '| Низковольтное оборудование',
    '[[getResources? &limit=`0` &parents=`-1` &resources=`91` &tpl=`tplGroupSelecror3`]]' => '<hr>',
    '[[getResources? &limit=`0` &parents=`-1` &resources=`61` &tpl=`tplBrandSelector`]]' => 'Бренд: Световые технологии',
    '[[getResources? &limit=`0` &parents=`-1` &resources=`96` &tpl=`tplBrandSelector2`]]' => '| Белый свет',
    '[[getResources? &limit=`0` &parents=`-1` &resources=`61` &tpl=`tplBrandSelector3`]]' => '<hr>',
    '[[getResources? &limit=`0` &parents=`-1` &resources=`89` &tpl=`tplGroupSelecror2`]]' => '| Светотехническая продукция',
    '[[getResources? &amp;limit=`6` &amp;parents=`14` &amp;depth=`0` &amp;hideContainers=`0` &amp;tpl=`tplPostavkiHome`
            &amp;includeTVs=`1` &amp;sortby=`{"id"}` ]]' => '<div class="col-lg-4 pos">
    <a class="posImg" style="background-image: url(assets/images/redside.jpg);">
        <div class="posBack">
            <div class="posTitle">
                ЖК «Ред Сайд»
...
<div class="col-lg-4 pos">
    ...
    '[[~11? &scheme=`full`]]' => '/abb.html',
    '[[~70? &scheme=`full`]]' => '/kuzocm.html',
    '[[~80? &scheme=`full`]]' => '/inkotex.html',
    '[[~59? &scheme=`full`]]' => '/dkc.html',
    '[[~60? &scheme=`full`]]' => '/schneider-electric.html',
    '[[~61? &scheme=`full`]]' => '/svetovye-tehnologii.html',
    '[[~62? &scheme=`full`]]' => '/iek.html',
    '[[~66? &scheme=`full`]]' => '/meka.html',
    '[[~63? &scheme=`full`]]' => '/tdm-еlectric.html',
    '[[~64? &scheme=`full`]]' => '/ekf.html',
    '[[~65? &scheme=`full`]]' => '/legrand.html',
    '[[~67? &scheme=`full`]]' => '/vergokan.html',
    '[[getResources? &amp;limit=`12` &amp;parents=`2` &amp;depth=`0` &amp;hideContainers=`0` &amp;tpl=`tplPartnerHome`
            &amp;includeTVs=`1` &amp;sortby=`{"id"}` ]]' => '<div class="col-lg-2">
    <a href="/abb.html">
        <img src="assets/images/abb-logo-png-transparent1.png" class="partnerImage">
    </a>
</div>
...
<div><a href="/modx/news/" >Новости</a></div>',
    '[[*foots]]' => '<script src="/modx/assets/js/jquery.spincrement.min.js"></script>
<script src="/modx/assets/js/wow.min.js"></script>
<script>
